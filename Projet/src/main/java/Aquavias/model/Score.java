...
public class Score {
  ...
  public static void recommencer(int lvl) {     // recommencer le niveau
  ...
  public static void suivant(int lvl) {         // niveau suivant
    MenuNiveau n = new MenuNiveau(25,13);
  ...
  public static void retour() {          // retourner à la liste des niveaux
    return;
  }
